 ...
 */
final class Version20191002145247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE userblog ADD encor VARCHAR(200) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE userblog DROP encor');
    }
}
